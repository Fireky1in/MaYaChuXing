...
public class MainPresenter extends MainContract.Presenter {
    ...
    @Override
    public void getCarStatus(boolean isDialog, boolean cancelable) {
        model.getCarStatus(context, isDialog, cancelable, new ObserverResponseListener() {
            @Override
            public void onNext(Object o) {
                //这一步是必须的，判断view是否已经被销毁
                if (getView() != null) {
                    getView().resultCarStatus((CarStatusBean) o);
                }
            }
    ...
    @Override
    public void getCloseCar(TreeMap<String, String> map, boolean isDialog, boolean cancelable) {
        model.getCloseCar(context, map, isDialog, cancelable, getView().bindLifecycle(), new ObserverResponseListener() {
            @Override
            public void onNext(Object o) {
                //这一步是必须的，判断view是否已经被销毁
                if (getView() != null) {
                    getView().resultCloseCar((CloseCarBean) o);
                }
            }
    ...
    @Override
    public void getIsOrder(boolean isDialog, boolean cancelable) {
        model.getIsOrder(context, isDialog, cancelable, new ObserverResponseListener() {
            @Override
            public void onNext(Object o) {
                //这一步是必须的，判断view是否已经被销毁
                if (getView() != null) {
