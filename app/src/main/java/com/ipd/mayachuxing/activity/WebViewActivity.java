...
//        dialogUtils.showProgress(this, "Loading...");
        ...
        switch (h5Type) {
            case 0: //充值协议
                h5Url = BASE_LOCAL_URL + "app/charge.html";
                break;
            case 1: //用户指南
                h5Url = BASE_LOCAL_URL + "app/user_guide.html";
                break;
            case 2: //招商加盟
                h5Url = BASE_LOCAL_URL + "app/join_group.html";
                break;
            case 3: //用户注册协议
                h5Url = BASE_LOCAL_URL + "app/agreement.html";
                break;
        }
